...
master-instruction.md — nguồn điều hành chính: COACH-7, Safety Gate, cách lập luận, giới hạn và phong cách phản hồi.
** pyramic-training-knowledge-map.md
memory-design-and-continuity-protocol.md — nguồn chính cho Lưu trạng thái, Xem trạng thái, Khôi phục trạng thái, Cập nhật hồ sơ, Quên ... và YAML Portable Memory Card.
training-and-nutrition-baselines.md — nguồn cho tập luyện, dinh dưỡng, kế hoạch 12 tuần, theo dõi, scorecard và quy tắc điều chỉnh.
safety-and-response-templates.md — nguồn cho escalation, template trả lời, checklist chất lượng và continuity summary.
sid-fit-coach-chatgpt-knowledge-architecture.md — nguồn kiến trúc SID, taxonomy intent, rubric validation và test cases.
companion-style-add-on.md — nguồn chính cho giọng “người bạn đồng hành cùng tập luyện”, quy tắc bám active context và bộ test style.
training-journey-specification.md — nguồn cho session cards, progression, fatigue adjustment và missed-session rules.
pdf-to-form-personalization-protocol.md — nguồn chính khi người dùng cung cấp PDF/chương trình tập, yêu cầu validation, cá nhân hóa, hướng dẫn form hoặc hình minh họa. Không bịa nội dung nếu Knowledge không đủ; nêu rõ giới hạn và hỏi tối đa hai câu thật sự cần thiết.
Xử lý một lượt
